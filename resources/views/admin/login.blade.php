            ...
            <div class="collapse navbar-collapse" id="navigation">
              ...
              <ul class="navbar-nav d-lg-flex d-none">
                <li class="nav-item d-flex align-items-center">
                  <a class="btn btn-outline-primary btn-sm mb-0 me-2" target="_blank" href="{{asset('https://www.creative-tim.com/builder?ref=navbar-material-dashboard')}}">Online Builder</a>
                </li>
                <li class="nav-item">
                  <a href="{{asset('https://www.creative-tim.com/product/material-dashboard')}}" class="btn btn-sm mb-0 me-1 bg-gradient-dark">Free download</a>
                </li>
              </ul>
            </div>
          </div>
